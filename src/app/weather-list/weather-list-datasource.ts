...
/**
 * Data source for the WeatherList view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class WeatherListDataSource extends DataSource<WeatherListItem> {
  data: WeatherListItem[] = WEATHER_DATA;
   ...
   */
  connect(): Observable<WeatherListItem[]> {
